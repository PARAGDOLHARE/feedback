...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLoginIn = findViewById(R.id.btnNext);
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (mFirebaseUser != null) {
                    Toast.makeText(LoginActivity.this, "You are LoggedIn!", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(LoginActivity.this, WelcomeActivity.class);
                    startActivity(i);

                } else {
                    Toast.makeText(LoginActivity.this, "Wrong Credentials,Email Not found!!", Toast.LENGTH_SHORT).show();
                }
            }
        };
